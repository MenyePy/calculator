...
if (isMobile()){
    ...
    for (let i = 0; i < btns.length; i++){
        btns[i].setAttribute('style', "width: 18vw;padding: 2vh 1vw;border: 2px inset #ddd;font-size: 20px;}");
    }
}
...
const operations = {
    ...
    '-': (a, b) => a - b,
    '×': (a, b) => a * b,
    '÷': (a, b) => {if (b!=0){return a/b} else {alert('Cannot divide by zero, you cheeky bastard'); return 0;   }},
}
